...
public class SlidingHelloWorldExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        matrix.print(300, new SlidingGlyphs(new Size(9, 32), Arrays.asList(H, e, l, l, o, SPACE, W, o, r, l, d, EXCLAMATION)));
        matrix.print(300, new SlidingGlyphs(new Size(9, 32), Arrays.asList(B, o, n, j, o, u, r, SPACE, l, e, SPACE, m, o, n, d, e, EXCLAMATION )));
    }
}