...
public class SlidingHelloWorldWithSequencerExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        matrix.print(Duration.ofSeconds(40), new LineFrameSequencerIterable(hello_world.iterator(), new LineFrameSequencer()));
        ...
        matrix.print(Duration.ofSeconds(40), new LineFrameSequencerIterable(bonjour_monde.iterator(), new LineFrameSequencer()));
    }
}